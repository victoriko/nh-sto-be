 ...
 */
public class ChaincodeVO extends Chaincode implements Serializable {
	...
	/**
	 * countChaincode attribute를 리턴한다.
	 *
	 * @return the countChaincode
	 */
	...
	/**
	 * countChaincode attribute 값을 설정한다.
	 *
	 * @param countChaincode
	 *            the countChaincode to set
	 */
